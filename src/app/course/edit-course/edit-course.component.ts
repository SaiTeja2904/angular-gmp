...
export class EditCourseComponent implements OnInit {
    ...
    constructor(private router: Router, private route: ActivatedRoute, private courseService: CourseService, private datePipe: DatePipe) {}
    ...
    ngOnInit() {
        ...
        if (course) {
            ...
            this.description = new FormControl(course.description, Validators.required);
            this.duration = new FormControl(course.duration, Validators.required);
            this.date = new FormControl(this.datePipe.transform(course.creationDate, "yyyy-MM-dd"), Validators.required);
